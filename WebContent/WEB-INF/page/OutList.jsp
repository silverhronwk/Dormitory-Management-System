            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr align="center"  class="t1">
                  ...
                  <c:forEach items="${out_students }" var="out_student">
                    <tr align="center">
                      <td height="25" align="center">${out_student.time}</td>
                      <td>${out_student.name}</td>
                      <td>${out_student.sex}</td>
                      <td>${out_student.class1}</td>
                      <td>${out_student.exitnotes}</td>
                      </tr>
                  </c:forEach>
              </table></td>
            </tr>
