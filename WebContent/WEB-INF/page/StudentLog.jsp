            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr align="center"  class="t1">
                  ...
                  <c:forEach items="${myLackofsleeps }" var="myLackofsleep">
                    <tr align="center">
                      <td height="25" align="center">${myLackofsleep.student.dormitory.name}</td>
                      <td>${myLackofsleep.student.name}</td>
                      <td>${myLackofsleep.student.sex}</td>
                      <td>${myLackofsleep.time}</td>
                      <td>${myLackofsleep.des}</td>
                      <td>${myLackofsleep.student.dormitory.building.buildingAdministrator.realname}</td>
                      </tr>
                   </c:forEach>
              </table></td>
            </tr>
