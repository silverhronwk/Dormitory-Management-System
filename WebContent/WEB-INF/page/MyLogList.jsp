            ...
            <tr>
              ...
              <form name="form1" method="post" action="MyLogList.action">
                  ...
                  <tr>
                    ...
                    <td width="72%">查询：
                      <select name="Domitory_ID" id="Domitory_ID">
                        ...
                        <c:forEach items="${dormitories}" var="dormitorie">
                        <option value="${dormitorie.id}">${dormitorie.name}</option>
                        </c:forEach>
                      </select>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <c:forEach items="${lackofsleeps }" var="lackofsleep">
                    <tr align="center">
                      <td height="25" align="center">${lackofsleep.student.dormitory.name}</td>
                      <td>${lackofsleep.student.name}</td>
                      <td>${lackofsleep.student.sex}</td>
                      <td>${lackofsleep.student.class1}</td>
                      <td>${lackofsleep.time}</td>
                      <td>${lackofsleep.des}</td>
                      </tr>
                  </c:forEach>
                </table></td>
            </tr>
