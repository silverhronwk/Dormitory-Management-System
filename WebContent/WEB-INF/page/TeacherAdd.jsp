        ...
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <input type="hidden" name="id" value="${buildingadministrator.id }">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="Teacher_Username" type="text" class="text2" id="Teacher_Username" value="${buildingadministrator.name }"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>密码：</td>
                    <td><input name="Teacher_Password" type="password" class="text2" id="Teacher_Password" value="${buildingadministrator.pwd }"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>重复密码：</td>
                    <td><input name="Teacher_Password2" type="password" class="text2" id="Teacher_Password2" value="${buildingadministrator.pwd }"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>姓名：</td>
                    <td><input name="Teacher_Name" type="text" class="text2" id="Teacher_Name" value="${buildingadministrator.realname }"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Teacher_Tel" type="text" class="text2" id="Teacher_Tel" value="${buildingadministrator.contact }"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
                    <td><input type="submit" name="button" id="button" value="添加楼宇管理员"><c:if test="${msg != null }">${msg}</c:if>
                      &nbsp;&nbsp;
