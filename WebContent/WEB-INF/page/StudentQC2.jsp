            ...
            <tr>
              ...
              <form name="form1" method="post" action="StudentQCSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="30">
                    	<input name="Student_ID" type="text" class="noshow" id="Student_ID" value="${student.id }">
                    	<input name="Student_DormitoryID" type="text" class="noshow" id="Student_DormitoryID" value="${student.dormitory.id }">
                    </td>
                    <td><input type="submit" name="button" id="button" value="确定迁出"><c:if test="${msg != null }">${msg}</c:if>
                      &nbsp;&nbsp;
