              ...
              <form name="form1" method="post" action="LogAddSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="67%"><c:if test="${Student != null }">${Student.stu_ID}</c:if>
                      <label for="Log_StudentID"></label>
                      <input name="Log_StudentID" type="text" class="noshow" id="Log_StudentID" value="${Student.stu_ID}">
                      <input name="Building_ID" type="hidden" value="${Student.dormitory.building.id}" >
                      </td>
                  </tr>
                  <tr>
